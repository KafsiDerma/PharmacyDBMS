...
namespace PharmacyDBMS.Migrations
{
    ...
    [Migration("20230413131525_secondfk1")]
    partial class secondfk1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmacyDBMS.Data.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 5440,
                            HashedPassword = "$2a$10$/B/HXrJnR7tJCjELbjG78.BVHhdT0wS806qTdRYxqTY8qt.ruBynm",
                            Name = "admin",
                            PhoneNumber = "123",
                            Position = 5,
                            Salary = 0f
            ...
            modelBuilder.Entity("PharmacyDBMS.Data.Patient", b =>
                {
                    b.HasOne("PharmacyDBMS.Data.InsuranceAgency", "ID")
                        .WithMany()
                        .HasForeignKey("InsuranceAgency");
