...
namespace PharmacyDBMS.Migrations
{
    ...
    [Migration("20230417125410_POfk4")]
    partial class POfk4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmacyDBMS.Data.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3440,
                            HashedPassword = "$2a$10$InOh2KTTJ7uXxvXr3HCX3erlB2kJk5/cj3nIuNHQEFWhhT960jRwq",
                            Name = "admin",
                            PhoneNumber = "",
                            Position = 5,
                            Salary = 0f
            ...
            modelBuilder.Entity("PharmacyDBMS.Data.Product", b =>
                {
                    b.HasOne("PharmacyDBMS.Data.prescription_only", null)
                        .WithMany("Products")
